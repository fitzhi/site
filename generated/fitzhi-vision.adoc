...
This chart is processed by evaluating the activity for each skill. We currently limit the view to the 9 most important skills, as declared in your portfolio, and a 10th gathering this rest. 

This limitation to 10, can by setup in the Front application. +
The size of each tile is proportional to this underlying activity. 
